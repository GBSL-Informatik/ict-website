...
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(90694);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(90445);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97375);
/* harmony import */ var _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(76257);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26312);
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Invalid date:" + str);
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  getConfig: () => (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.s,
  getAccTitle: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.g,
  setDiagramTitle: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.q,
  getDiagramTitle: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.t,
  setDisplayMode,
  getDisplayMode,
  setAccDescription: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.b,
  getAccDescription: _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.a,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt;
  const securityLevel = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  let sandboxElement;
  ...
  (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_1__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_1__(minTime), "year") > 5) {
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.l.warn(
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
      const rows = d[0].split(_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex);
