    ...
    return (function e(a, r, o) {
    ...
    })(
        {
                ...
                function (e, a, r) {
                    ...
                    var o,
                        ...
                        l = function (e) {
                            ...
                            return (
                                (a = n.map(t, s(e)).sort(function (e, a) {
                                    var r = function (e) {
                        ...
                        return [
                            function (a) {
                                ...
                                return (
                                    ...
                                    !!r && { level: 'insecure', id: 'common', value: r }
                                );
                            }
                        ];
                    });
                },
                { '../check': 5, 'hsimp-library': 10 }
            ],
            7: [
                function (e, a, r) {
                    'use strict';
            ...
            8: [
                function (e, a, r) {
                    a.exports = {
                        '^correcthorsebatterystaple|Tr0ub4dor&3$': { level: 'insecure', id: 'xkcd' },
                        '^jeff|geoff$': { level: 'easteregg', id: 'jeff' },
                        '^.{1,6}$': { level: 'warning', id: 'lengthVeryShort' },
                        '^[a-zA-Z]{1,16}$': { level: 'warning', id: 'possiblyWord' },
                        '^[0-9]+$': { level: 'warning', id: 'onlyNumbers' },
                        '^([a-zA-Z]+[0-9]+|[0-9]+[a-zA-Z]+)$': { level: 'warning', id: 'wordAndNumber' },
                        '^.{7,9}$': { level: 'warning', id: 'lengthShort' },
                        '^[A-Za-z]+$': { level: 'notice', id: 'justLetters' },
                        '^(?:\\d+[a-zA-Z]|[a-zA-Z]+\\d)[a-zA-Z\\d]*$': { level: 'notice', id: 'noSymbols' },
                        '^[\\-\\(\\)\\.\\/\\s0-9]+$': { level: 'warning', id: 'telephone' },
                        '(.+)\\1{2,}': { level: 'warning', id: 'repeatedPattern' },
                        '[^A-Za-z0-9\\u0000-\\u007E]': { level: 'achievement', id: 'nonStandardCharacters' },
                        '^.{17,}$': { level: 'achievement', id: 'lengthLong' }
                    };
                },
                {}
            ],
                ...
                function (e, a, r) {
                    ...
                    var o = function (e) {
                        ...
                        d = o(function (e, a) {
                            ...
                            else for (r in a) if (a.hasOwnProperty(r) && !1 === e(a[r], r)) break;
                        }),
                        m = function (e, a) {
            ...
            11: [
                function (e, a, r) {
                    a.exports = function (a) {
                        ...
                        a.setDictionary(r),
                            a.setPeriodDictionary(o),
                            a.setNamedNumberDictionary(n),
                            a.setCheckerDictionary(i),
                            a.setCharacterSets(e('hsimp-character-sets/character-sets.json'));
                        var s = e('hsimp-checks/checks/patterns'),
                            t = e('hsimp-checks/checks/common');
                        return (
                            s.setDictionary(e('hsimp-checks/dictionaries/patterns.json')),
                            t.setDictionary(e('hsimp-checks/dictionaries/top10k.json')),
                            a.setCheckerChecks([s, t]),
                            a
                        );
                    };
                },
            ...
            12: [
                function (e, a, r) {
                    a.exports = { instantly: 'Instantly', forever: 'Forever' };
                },
                {}
            ],
            13: [
                function (e, a, r) {
                    ...
                    var o = e('hsimp-library'),
                        ...
                        s = { calculationsPerSecond: 1e10, good: 315576e8, ok: 31557600 },
                        t = {},
                        l = o.memoize(function (e) {
                            ...
                            return (
                                p.isInsecure()
                                    ? ((y = 'insecure'), (c = 0), (g = n.instantly))
                                    : c >= t.good
                                      ? (y = p.hasWarnings() ? 'ok' : 'good')
                                      : c >= t.ok && (y = 'ok'),
                                (a.getSecurityLevel = o.output(y)),
                                (a.getPossibleCombinations = o.output(l)),
                                (a.getTimeInSeconds = o.output(c)),
                                (a.getString = o.output(g)),
                                (a.getTimeString = o.output(g)),
                                a
                            );
                        });
                    (l.setDictionary = function (e) {
                        ...
                        (l.setPeriodDictionary = i.period.setDictionary),
                        (l.setNamedNumberDictionary = i.namedNumber.setDictionary),
                        (l.setCheckerDictionary = i.checker.setDictionary),
                        (l.setCharacterSets = i.characterSets.setCharacterSets),
                        (l.setCheckerChecks = i.checker.setChecks),
                    ...
                    var o,
                        ...
                        l = function (e) {
                            var a = e.toExponential(),
                                ...
                                n = 0;
                            return (
                                r && r.length >= 3 && ((o = +r[1]), (n = +r[2])),
                                { significand: o, exponent: n }
                            );
                        },
                        c = function (e) {
                            ...
                            return s || t
                                ? (s && 2 === s.length
                                      ? ((a = s[1].split(/\s+/)),
                                        ...
                                        (n = (t * Math.pow(10, l)).toPrecision(t.toString().length)),
                                        (n = +n))
                                      : (n = t),
                                  n)
                                : e;
                        ...
                        p = function (e) {
                            ...
                            if ((i.isString(e) && (e = h(e)), !i.isNumber(e) || isNaN(e)))
                                throw { type: 'invalidNumber', value: e };
                            return (
                                (r = l(e)),
                                (n = r.significand),
                                (s = r.exponent),
                                (t.getSignificand = function () {
                                    return n;
                                }),
            ...
            16: [
                function (e, a, r) {
                    a.exports = [
                        { singular: 'yoctosecond', plural: 'yoctoseconds', seconds: 1e-24 },
                        { singular: 'zeptosecond', plural: 'zeptoseconds', seconds: 1e-21 },
                        { singular: 'attosecond', plural: 'attoseconds', seconds: 1e-18 },
                        { singular: 'femtosecond', plural: 'femtoseconds', seconds: 1e-15 },
                        { singular: 'picosecond', plural: 'picoseconds', seconds: 1e-12 },
                        { singular: 'nanosecond', plural: 'nanoseconds', seconds: 1e-9 },
                        { singular: 'microsecond', plural: 'microseconds', seconds: 1e-6 },
                        {
                        ...
                        { singular: 'hour', plural: 'hours', abbreviations: ['h'], seconds: 3600 },
                        { singular: 'day', plural: 'days', seconds: 86400 },
                        { singular: 'week', plural: 'weeks', seconds: 604800 },
                        { singular: 'month', plural: 'months', seconds: 2626560 },
                        { singular: 'year', plural: 'years', seconds: 31557600 }
                    ];
                },
                {}
            ],
                ...
                function (e, a, r) {
                    ...
                    var o,
                        ...
                        m = function (e, a) {
                            var r = s(a);
                            return (
                                a.hasOwnProperty('singular') && (e[a.singular] = r),
                                a.hasOwnProperty('plural') && (e[a.plural] = r),
                                a.hasOwnProperty('abbreviations') &&
                                    i.isArray(a.abbreviations) &&
                                    i.forEach(function (a) {
                                        e[a] = r;
                                    }, a.abbreviations),
                                e
                    ...
                    (u.setDictionary = function (e) {
                        return (
                            (n = i.sortBy('seconds', e)),
                            (o = i.reduce(m, {}, e)),
                            (t = i.first(i.filter(l, e), t).singular),
                            u
                        );
                    }),
                        (a.exports = u);
                            ...
                            a.setAttribute('class', r),
                                ...
                                a.addEventListener('keyup', function () {
                                    ...
                                    a.value.length
                                        ? (a.setAttribute(
                                              'class',
                                              r + ' hsimp-level--' + e.getSecurityLevel()
                                          ),
                                          i(e.getString(), a),
                                          s(e.getChecks(), a))
                                        : (a.setAttribute('class', r), i(!1, a), s([]));
                                });
                        });
                    (i.setDictionary = o.setDictionary),
                        (i.setPeriodDictionary = o.setPeriodDictionary),
                        (i.setNamedNumberDictionary = o.setNamedNumberDictionary),
                        (i.setCheckerDictionary = o.setCheckerDictionary),
                        (a.exports = i);
                },
                { 'hsimp-library': 10, 'hsimp-main': 13, 'hsimp-main/bootstrap': 11 }
            ]
        },
        {},
        [18]
