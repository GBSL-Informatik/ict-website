...
Wähle vier zufällige Wörter. Verwende beispielsweise einen [Webdienst](https://capitalizemytitle.com/zufallswort-generator/) dazu.
Überlege dir anschliessend eine Visualisierung, mit welcher du dir diese Wörter merken kannst.
...
Am sichersten ist es, zufällige Passwörter zu verwenden, welche du in einem Passwortmanager verwaltest.
So musst du dir nur ein (sicheres!) Passwort merken; dasjenige für den Passwortmanager.
Im Manager kannst du für jeden Dienst automatisch ein sicheres Passwort erzeugen lassen.
