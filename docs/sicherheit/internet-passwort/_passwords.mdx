...
- [BitWarden](https://bitwarden.com/) (Empfehlung) - gute Basis-Funktionen und einfaches Handling, zudem open-source.
- [KeePass](https://keepass.info/)
- [LastPass](https://www.lastpass.com/)

:::info[Browser-Passwort-Manager]
Im Gegensatz zu Lösungen wie dem Browser-Passwort-Manager sind Passwort-Manager speziell für die Verwaltung von Passwörtern entwickelt und bieten mehr Sicherheit.
:::