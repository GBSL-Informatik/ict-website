...
const keywords = admonitionKeywords.map(escapeRegExp).join('|');
...
files.forEach((file, idx) => {
    return fs.readFile(file, 'utf8', function (err, data) {
        ...
        replacers.forEach((r, idx) => {
            ...
            const closerIdx = replacers.findIndex(
                (r2) => r2.line > r.line && r2.id === r.id && r2.type === 'close'
            );
