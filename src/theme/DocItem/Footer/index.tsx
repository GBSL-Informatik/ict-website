            ...
            <div className={styles.badges}>
                {sidebar_custom_props.source === 'gym-kirchenfeld' && (
                    <div className={styles.sources}>
                        ...
                        <i className={clsx(styles.edited, 'badge', 'badge--primary')}>Bearbeitet</i>
                    </div>
                )}
                ...
                <a
                    ...
                    href={`mailto:ICT%20Feedback<ict.gbsl@bernedu.ch>?subject=${encodeURIComponent('Feedback ict.gbsl.website')}&body=${encodeURIComponent(feedbackBody)}`}
                >
                    Rückmeldung{' '}
                    <Icon
                        path={mdiEmailFast}
                        ...
                        style={{ marginLeft: '8px', marginRight: '4px', transform: 'scale(2.5)' }}
                    />
                </a>
            </div>
            <Footer {...props} />
